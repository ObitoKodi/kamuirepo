...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://watchtvseries.unblocked.llc/'
        self.search_link = 'https://watchtvseries.unblocked.llc/show/search-shows-json'
        self.search_link_2 = 'https://watchtvseries.unblocked.llc/search/%s'
