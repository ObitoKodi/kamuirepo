...
def HostChcker():
    ...
    elif url_ok("https://icefilms.unblocked.llc"):
        useurl = 'https://icefilms.unblocked.llc/'
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['icefilms.info','icefilms.unblocked.llc','www6-icefilms6-info.unblocked.lol']
