...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.kamui.container.items'

        self.metaProperty = 'plugin.video.kamui.container.meta'
        
        scraperSetting = control.setting('module.provider')

        try:
            if xbmc.getCondVisibility('System.HasAddon(%s)' % 'script.module.openscrapers') and not scraperSetting == 'Default':
