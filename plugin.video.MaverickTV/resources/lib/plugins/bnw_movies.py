        ...
        try:
            ...
            if link2 == "-":          
                xml += "<item>"\
                       ...
                       "<fanart>%s</fanart>"\
                       "<summary>%s</summary>"\
                       "</item>" % (name,name,link1,thumbnail,fanart,summary)
            elif link3 == "-":
                xml += "<item>"\
                       "<title>%s</title>"\
                       "<meta>"\
                       ...
                       "<fanart>%s</fanart>"\
                       "<summary>%s</summary>"\
                       "</item>" % (name,name,link1,link2,thumbnail,fanart,summary)
            elif link4 == "-":
                xml += "<item>"\
                       "<title>%s</title>"\
                       "<meta>"\
                       ...
                       "<fanart>%s</fanart>"\
                       "<summary>%s</summary>"\
                       "</item>" % (name,name,link1,link2,link3,thumbnail,fanart,summary)
            else:
                xml += "<item>"\
                       "<title>%s</title>"\
                       "<meta>"\
                       ...
                       "<fanart>%s</fanart>"\
                       "<summary>%s</summary>"\
                       "</item>" % (name,name,link1,link2,link3,link4,thumbnail,fanart,summary)
        except:
            pass                                                            
    jenlist = JenList(xml)
