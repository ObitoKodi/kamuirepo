...
if action == None:
    ...
    if cache._find_cache_version(): run = 'true'  #check whether script.module.kamui has been updated
    if cache._find_cache_versionAlt(): run = 'true' #check whether plugin.video.kamui has been updated.  Added function to script.module.kamui/lib/resources/modules/cache - def _find_cache_versionAlt()
    if run == 'true':
